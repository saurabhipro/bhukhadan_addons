...
export class BhuKhadanHierarchyTree extends Component {
    ...
    getRoleIcon(role) {
        const icons = {
            'halka_patwari': 'fa-pencil-square',
            'revenue_inspector': 'fa-search',
            'tehsildar': 'fa-shield',
            'nodal_officer_lr': 'fa-briefcase',
            'general_manager_oprn': 'fa-university',
            'sub_area_manager_gm_min': 'fa-briefcase',
            'area_finance_manager': 'fa-balance-scale',
            'staff_officer_pp': 'fa-cogs',
            'staff_officer_hr': 'fa-users',
            'staff_officer_civil': 'fa-wrench',
            'area_survey_officer': 'fa-map-marker',
            'sub_engineer': 'fa-cog',
            'pwd_officer': 'fa-road',
            'deputy_forest_officer': 'fa-tree',
            'forest_range_officer': 'fa-leaf',
            'horticulture_superintendent': 'fa-pagelines',
