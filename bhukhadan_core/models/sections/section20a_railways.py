...
class Section20ARailways(models.Model):
    _name = 'bhu.section20a.railways'
    _description = 'Section 20 A (Railways) / धारा 20 ए (रेलवे)'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                ...
                if project_id:
                    ...
                    sequence_code = 'bhu.section20a.railways'
                    if project:
                        sequence_code = f'bhu.section20a.railways.{project.id}'
