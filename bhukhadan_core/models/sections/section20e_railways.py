...
class Section20ERailways(models.Model):
    _name = 'bhu.section20e.railways'
    _description = 'Section 20 E (Railways) / धारा 20 ई (रेलवे)'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                ...
                if project_id:
                    ...
                    sequence_code = 'bhu.section20e.railways'
                    if project:
                        sequence_code = f'bhu.section20e.railways.{project.id}'
