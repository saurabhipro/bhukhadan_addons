...
class Section3DNH(models.Model):
    _name = 'bhu.section3d.nh'
    _description = 'Section 3D (NH) / धारा 3डी (राष्ट्रीय राजमार्ग)'
        ...
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                ...
                if project_id:
                    ...
                    sequence_code = 'bhu.section3d.nh'
                    if project:
                        sequence_code = f'bhu.section3d.nh.{project.id}'
